...
import dev.brume.core.Environment;
import dev.brume.core.LogConfig;
...
public class AsyncBrumeClientBuilder {
  ...
  private String apiKey = System.getenv("BRUME_API_KEY");
  ...
  /**
   * Sets apiKey.
   * Defaults to the BRUME_API_KEY environment variable.
   */
  public AsyncBrumeClientBuilder apiKey(String apiKey) {
    this.apiKey = apiKey;
    return this;
  }

  public AsyncBrumeClientBuilder url(String url) {
   ...
   */
  public AsyncBrumeClientBuilder timeout(int timeout) {
   ...
   */
  public AsyncBrumeClientBuilder maxRetries(int maxRetries) {
   ...
   */
  public AsyncBrumeClientBuilder httpClient(OkHttpClient httpClient) {
   ...
   */
  public AsyncBrumeClientBuilder logging(LogConfig logging) {
   ...
   */
  public AsyncBrumeClientBuilder addHeader(String name, String value) {
  ...
  public AsyncBrumeClient build() {
    if (apiKey == null) {
      throw new RuntimeException("Please provide apiKey or set the BRUME_API_KEY environment variable.");
    }
    validateConfiguration();
    return new AsyncBrumeClient(buildClientOptions());
  }
}

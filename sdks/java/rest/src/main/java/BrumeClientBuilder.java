...
public class BrumeClientBuilder {
   ...
   */
  public BrumeClientBuilder apiKey(String apiKey) {
    this.apiKey = apiKey;
    return this;
  }

  public BrumeClientBuilder url(String url) {
   ...
   */
  public BrumeClientBuilder timeout(int timeout) {
   ...
   */
  public BrumeClientBuilder maxRetries(int maxRetries) {
   ...
   */
  public BrumeClientBuilder httpClient(OkHttpClient httpClient) {
   ...
   */
  public BrumeClientBuilder logging(LogConfig logging) {
   ...
   */
  public BrumeClientBuilder addHeader(String name, String value) {

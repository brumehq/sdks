...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal async global::System.Threading.Tasks.Task<global::Brume.Rest.Core.ApiResponse> SendRequestAsync(
        global::Brume.Rest.Core.BaseRequest request,
    ...
    /// </summary>
    private async global::System.Threading.Tasks.Task<global::Brume.Rest.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    )
    {
        ...
        if (!isRetryableContent || maxRetries == 0)
        {
            var response = await httpClient
                ...
                .ConfigureAwait(false);
            return new global::Brume.Rest.Core.ApiResponse
            {
    ...
    private string BuildUrl(global::Brume.Rest.Core.BaseRequest request)
    {

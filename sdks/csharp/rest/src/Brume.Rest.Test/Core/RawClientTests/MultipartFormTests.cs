...
namespace Brume.Rest.Test.Core.RawClientTests;
...
public class MultipartFormTests
{
    ...
    private static Brume.Rest.Core.MultipartFormRequest CreateMultipartFormRequest()
    {
        return new Brume.Rest.Core.MultipartFormRequest
        {

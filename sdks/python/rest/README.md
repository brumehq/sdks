# Brume Python Library

[![fern shield](https://img.shields.io/badge/%F0%9F%8C%BF-Built%20with%20Fern-brightgreen)](https://buildwithfern.com?utm_source=github&utm_medium=github&utm_campaign=readme&utm_source=Brume%2FPython)
[![pypi](https://img.shields.io/pypi/v/brume)](https://pypi.python.org/pypi/brume)
...
```python
from brume.core.api_error import ApiError
...
client = BrumeClient(..., timeout=20.0)

...
func TestWebhooksDeleteWithWireMock(
    ...
    require.NoError(t, invocationErr, "Client method call should succeed")
    VerifyRequestCount(t, "TestWebhooksDeleteWithWireMock", "DELETE", "/v1/webhooks/id", nil, 1)
}
...
func TestWebhooksListDeliveriesWithWireMock(
    ...
    require.NoError(t, invocationErr, "Client method call should succeed")
    VerifyRequestCount(t, "TestWebhooksListDeliveriesWithWireMock", "GET", "/v1/webhooks/id/deliveries", nil, 1)
}
...
func TestWebhooksTestWithWireMock(
    ...
    require.NoError(t, invocationErr, "Client method call should succeed")
    VerifyRequestCount(t, "TestWebhooksTestWithWireMock", "POST", "/v1/webhooks/id/test", nil, 1)
}

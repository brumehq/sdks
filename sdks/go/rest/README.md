...
[![fern shield](https://img.shields.io/badge/%F0%9F%8C%BF-Built%20with%20Fern-brightgreen)](https://buildwithfern.com?utm_source=github&utm_medium=github&utm_campaign=readme&utm_source=Brume%2FGo)
...
import (
    ...
    client "github.com/brumehq/brume-rest-go/client"
    option "github.com/brumehq/brume-rest-go/option"
)

func do() {
    client := client.NewBrumeClient(
        option.WithAPIKey(
            "<token>",
        ),
    )
...
client := client.NewClient(
    option.WithAPI Key("<YOUR_API_KEY>"),

...
require_relative "lib/Brume/version"
...
Gem::Specification.new do |spec|
  spec.name = "Brume"
  spec.authors = ["Brume"]
  spec.version = Brume::VERSION
  spec.summary = "Ruby client library for the Brume API"
  spec.description = "The Brume Ruby library provides convenient access to the Brume API from Ruby."

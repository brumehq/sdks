...
describe Brume::Internal::Types::Utils do
  Utils = Brume::Internal::Types::Utils

  module TestUtils
    class M < Brume::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < Brume::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < Brume::Internal::Types::Model
      literal :type, "B"
      field :only_on_b, String
    end

    module U
      extend Brume::Internal::Types::Union
    ...
    SymbolStringHash = Brume::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { Brume::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Array" do
      StringArray = Brume::Internal::Types::Array[String]
      ModelArray = -> { Brume::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { Brume::Internal::Types::Array[TestUtils::U] }

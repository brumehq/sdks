...
describe Brume::Internal::Types::Union do
  class Rectangle < Brume::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < Brume::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < Brume::Internal::Types::Model

...
describe Brume::Internal::Types::Model do
  ...
  class ExampleModel < Brume::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < Brume::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < Brume::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < Brume::Internal::Types::Model
